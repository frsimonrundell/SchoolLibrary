...
@EndOfDesignText@
'Custom View class
#DesignerProperty: Key: TotalId, DisplayName: Add To Total, DefaultValue: ,FieldType: String, Description: Id of total for this column
...
Public Sub DesignerCreateView (Base As Pane, Lbl As Label, Props As Map)
	...
	Lbl.Tag = Props.GetDefault("TotalId","")
